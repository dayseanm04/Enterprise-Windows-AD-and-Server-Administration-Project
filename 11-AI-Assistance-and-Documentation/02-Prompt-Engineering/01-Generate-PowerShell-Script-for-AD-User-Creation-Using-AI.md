...
I first tested it in the **TST-AD-SRV** Virtual Machine, which represents a test environment. What ever change I make in the test environment dosent affect the production server which is **Win-2019-SRV**
